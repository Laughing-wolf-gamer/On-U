...
export const adminSideBarMenu = [
    ...
    },
    {
        ...
        dropDownView:[
            {
                id:'adminHome',
                label:'Home Banners Feautres',
                accessRole:["admin",'superAdmin'],
                path: 'features/home',
            },
            {
                id:'categoryBanners',
                label:'Home Category Banner Feautres',
                accessRole:["admin",'superAdmin'],
                path: 'features/categoryBanners',
            },
            {
                id:'CouponManagement',
                label:'Coupon Management Feautres',
                accessRole:['superAdmin'],
                path: 'features/couponManagement',
            },
			{
                id:'couponBanner',
                label:'Home Coupon Banner Feautres',
                accessRole:['superAdmin'],
            ...
            },
			{
                ...
                label:'Products Options Feautres',
                accessRole:['superAdmin'],
                path: 'features/addOptions',
            },
            {
                id:'addressManagement',
                label:'Address Data Feautres',
                accessRole:['superAdmin'],
