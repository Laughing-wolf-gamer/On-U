        ...
        >
          <div className='grid grid-cols-5 px-8 py-4 cursor-pointer'>
            ...
            <div className=" h-[418px]">
              <h1 className='text-red-600 text-sm font-semibold py-1'>Topwear</h1>
              {Topwear.map((data) =>
              ...
              <hr className='py-1' />
              <h1 className='text-red-600 text-sm font-semibold py-1'>Indian&nbsp;&&nbsp;Festive&nbsp;Wear</h1>
            ...
            <div className=" h-[418px] ">
              ...
              <hr className='py-1' />
              <h1 className='text-red-600 text-sm font-semibold py-1'>Personal&nbsp;Care&nbsp;&&nbsp;Grooming</h1>
              <hr className='py-1' />
            ...
            <h1 className='text-red-600 text-sm font-semibold py-1'>Sports&nbsp;&&nbsp;Active&nbsp;Wear</h1>
              ...
              <hr className='py-1' />
              <h1 className='text-red-600 text-sm font-semibold py-1'>Gadgets</h1>
              {Gadgets.map((data) =>
                <Link to="/products"><li className='litext list-none py-0.5 hover:font-semibold'onClick={()=> parentCallback('hidden', false)}>{data.title}</li></Link>
              )}
            ...
            <div className=" h-[418px] ">
            <h1 className='text-red-600 text-sm font-semibold py-1'>Fashion&nbsp;Accessories</h1>
