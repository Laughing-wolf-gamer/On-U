	...
	return (
		<div className="relative w-full max-w-md mx-auto">
			<button
				...
				className={`w-full text-white p-4  rounded-md mt-6  ${HasStarted || arrowPosition > 0 ? "bg-[#32A76B]":"bg-black hover:bg-gray-800 disabled:bg-gray-700"} flex justify-center items-center relative overflow-hidden transition-all duration-300 ease-out`}
				style={{
