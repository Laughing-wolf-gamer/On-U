                ...
                <div className='fixed w-max  right-0 top-1/3 z-10 flex'>
                  ...
                  <div className={`${cou ? 'block': 'hidden'} w-[576px] h-[288px] background`}>
                      <div className="h-[80%] py-[24px] px-[40px]">
                        <div className="flex  text-[#3e4152]">
                          <div className='w-3/4'>
                        ...
                        <div className="flex py-4">
                          <div className="text-[#3e4152]  font-semibold w-4/6">
                          <span className='text-base'>Coupon Code:</span> <span className='text-lg'>ONU300</span>
                          <div className='text-xs font-kumbsan font-light'>Applicable on your first order</div>
                          </div>
                          <div className="">
                           <Link to='/registeruser'>
                           <button className='bg-[#ff3f6c] text-center rounded-[4px] mx-auto  text-white px-6 py-3'onClick={()=>(cou ? setcou(false):setcou(true))}>
                              SING UP NOW 
                            </button>
                            </Link> 
                          </div>
