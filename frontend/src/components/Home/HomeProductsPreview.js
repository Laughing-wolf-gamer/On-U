...
const HomeProductsPreview = ({ product }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute bottom-0 left-1/2 transform z-20 -translate-x-1/2 w-full h-10 justify-center items-center flex text-white bg-gray-800 hover:bg-gray-700 text-center font-semibold transition-all duration-300 ease-in-out ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[30px]'}`}
            >
