...
const ProductPreviewFull = ({ product ,user}) => {
    ...
    return (
        <Fragment>
            ...
            <div className="w-auto h-auto justify-center items-center space-x-4 flex mb-6 font1">
            ...
            <div className="w-screen h-fit flex flex-row justify-center items-center bg-slate-200 md:px-10 sm:px-8 xl:px-10 2xl:px-10 px-1">
                ...
                {previewProducts && previewProducts.length > 0 &&
                    ...
                    return (
                        <div className="2xl:w-[220px] 2xl:h-[400px] xl:w-[220px] xl:h-[400px] md:w-[220px] md:h-[400px] w-[200px] h-[380px] m-2 rounded-md bg-blue-400 relative flex flex-col justify-between items-center hover:shadow-md transform transition-all duration-300 ease-in-out hover:scale-105" key={p._id}>
