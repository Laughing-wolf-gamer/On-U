...
const ProductPreviewFull = ({ product }) => {
    ...
    return (
        ...
        <div className='w-full text-center flex flex-row justify-center items-center text-white font-sans text-xl relative transform transition-all'>
            <div className='shine-effect relative min-w-full justify-center items-center flex pb-6'>
                <div onClick={()=> navigation('/products')} className='px-8 w-fit text-sm md:text-lg bg-gray-900 rounded-full hover:bg-gray-700 mt-8 p-4 cursor-pointer hover:scale-110 duration-300 hover:animate-shine'>
                    <span>VIEW MORE</span>
                </div>
