  ...
  return (
    <Fragment>
      ...
      >
        ...
        <div className='absolute h-20 top-1/2 left-4 transform -translate-y-1/2 z-10'>
          <button
            className={`flex my-auto text-gray-400 opacity-[50%] hover:text-purple-400`}
            onClick={(e) => {
              e.preventDefault();
        ...
        <div className='absolute h-20  top-1/2 right-4 transform -translate-y-1/2 z-10'>
          <button
            className={`h-full w-full text-gray-400 opacity-[50%] hover:text-purple-400`}
            onClick={(e) => {
              e.preventDefault();
              console.log("Change Index: ", currentIndex);
