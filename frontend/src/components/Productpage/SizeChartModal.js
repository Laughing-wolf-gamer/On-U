...
const SizeChartModal = ({sizeChartData}) => {
  ...
  return (
    <div className='pl-3 md:pl-3 lg:pl-0 2xl:pl-0'>
      {/* Button to open the modal */}
      <button
        onClick={toggleModal}
        className="font1 mt-2 font1 lg:font-semibold 2xl:font-semibold md:font-semibold text-[14px] md:text-xl font-thin w-full justify-start items-start flex flex-row space-x-2"
      >
        <h1 className='text-[14px] md:text-xl font-semibold'>SIZE CHART: </h1>
