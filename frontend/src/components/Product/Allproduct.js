                ...
                <div className="w-full 2xl:grid xl:grid lg:grid 2xl:grid-cols-12 xl:grid-cols-12 lg:grid-cols-12 bg-white 2xl:px-10">
                    ...
                    <div className="w-full 2xl:col-span-10 xl:col-span-10 lg:col-span-10 2xl:p-4 xl:p-4 lg:p-4 bg-gray-50 text-slate-900 2xl:ml-7 lg:ml-5">
                        {productLoading ? (
                            ...
                            <div className='min-h-[100vw] flex flex-col justify-between items-start'>
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 2xl:gap-6 lg:gap-6 md:gap-5 sm:gap-5 gap-2 pr-3 md:pr-4 sm:pr-1 2xl:pr-5">
