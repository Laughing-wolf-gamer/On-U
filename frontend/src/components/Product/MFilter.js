    ...
    <Fragment>
      ...
      <div className={`${sortvi} z-20 bg-[#18181846] w-full h-full fixed top-0`} onClick={() => setsortvi('hidden')}>
        <div className='absolute bottom-0 h-[45%] w-full bg-white'>
          ...
          <div className="text-base font1 py-3 px-6 flex justify-start items-center"><AiOutlineFire className='text-xl mr-2' onClick={() => setsortvi('hidden')} />Popularity</div>
          <div className="text-base font1 py-3 px-6 flex justify-start items-center"><AiOutlineStar className='text-xl mr-2' onClick={() => (datefun(1), setsortvi('hidden'))} />Latest</div>
          <div className="text-base font1 py-3 px-6 flex justify-start items-center" onClick={() => (pricefun(-1), setsortvi('hidden'))}>
            <img src={Per} width='28px' alt="jhgjhsd" /> Discount
          </div>
          <div className="text-base font1 py-3 px-6 flex justify-start items-center" onClick={() => (pricefun(-1), setsortvi('hidden'))}>
