				...
				<div className="bg-slate-100 py-12 px-6 lg:px-24">
					...
					<header className="text-center mb-12">
						...
						<p className="mt-4 text-lg text-gray-700 sm:text-xl md:text-2xl">
							...
							Where innovation meets style – Your go-to Fashion destination
						</p>
					</header>
					...
					{/* Values Section */}
					<section className="bg-slate-400 py-12 shadow-lg rounded-xl">
						<div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
							{
								aboutData && aboutData.outMoto.length > 0 ? aboutData.outMoto.map((moto, index) => (
									<Fragment key={`moto-${index}`}>
										<div className="text-center bg-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
