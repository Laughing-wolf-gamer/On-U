                                ...
                                {currentWishListItem.map((pro) => (
                                    ...
                                    >
                                        <div className="shadow-lg rounded-lg overflow-hidden transition-all hover:shadow-xl">
                                            ...
                                            {/* Remove button */}
                                            <div className="absolute top-3 right-3 bg-gray-900 text-white rounded-full p-2 z-10 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer group sm:hidden">
                                                <MdClear className="text-xl sm:text-2xl" onClick={(e) => handleDelWish(e, pro?.productId?._id || pro?.productId, pro)} />
                                            </div>
                                        </div>
                                    </li>
                                ))}
